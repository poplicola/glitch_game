...
c_MyApp.prototype.p_OnRender=function(){
	...
	bb_graphics_DrawImage(this.m_background,0.0,0.0,0);
	this.p_RenderBricks();
...
c_Glitch.m_Update=function(){
	...
	if(t_severity>c_Glitch.m_severityPrevious){
		...
		do{
			t_which.p_Clear();
			do{
				var t_choice=((bb_random_Rnd3(c_Glitch.m_ALL.length))|0);
		...
		for(var t_n2=0;t_n2<c_Glitch.m_ALL.length;t_n2=t_n2+1){
			c_Glitch.m_ToggleGlitchById(t_n2,t_which.p_Contains(t_n2));
		}
